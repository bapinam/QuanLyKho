...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var RAW_EN_LOCALE = {
        ...
        weekText: 'W',
        allDayText: 'Các kế hoạch',
        moreLinkText: 'more',
        noEventsText: 'No events to display',
    };
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'vi';
    ...
    function buildDateEnv(settings) {
        var locale = buildLocale(settings.locale || 'vi', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
