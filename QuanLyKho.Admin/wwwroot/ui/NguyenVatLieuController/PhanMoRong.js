...
function CheckNameDongGoiThem() {
    ...
    $.ajax({
        type: "GET",
        url: url,
        data: { ten: ten, id: idNVLDVT, idDVT: null, loaiDongGoi: false },
        dataType: "json",
        success: function (msg) {
            if (!msg.isSuccessed) {
                document.getElementById("ShowTenDongGoi").style.display = 'none';
...
function CheckNameDG() {
    ...
    $.ajax({
        type: "GET",
        url: url,
        data: { ten: val, id: idNVLDVT, idDVT: idDVT, loaiDongGoi: false },
        dataType: "json",
        success: function (msg) {
            if (!msg.isSuccessed) {
...
function CheckNameDGTuChon(idDVT) {
    ...
    $.ajax({
        type: "GET",
        url: url,
        data: { ten: te, id: idLoaiE, idDVT: idDVT, loaiDongGoi: false },
        dataType: "json",
        success: function (msg) {
            if (!msg.isSuccessed) {
